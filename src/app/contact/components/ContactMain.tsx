...
export default function ContactMain() {
  ...
  const contactCards = [
    {
      href: 'https://wa.me/528116333559?text=Hola%20Nazre%2C%20me%20interesa%20conocer%20m%C3%A1s%20sobre%20Pneuma%20Studio',
      target: '_blank',
      icon: (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          ...
          <ScrollAnimator>
            <div className="flex flex-col gap-4">
              ...
              {/* CTA button */}
              <a
                href={process.env.NEXT_PUBLIC_CAL_COM_LINK || 'https://wa.me/528116333559?text=Hola%20Nazre%2C%20me%20gustar%C3%ADa%20agendar%20una%20llamada%20de%2030%20minutos%20con%20Pneuma%20Studio'}
                target="_blank"
